...
//         <div className="absolute bottom-0 left-0 right-0 translate-y-full bg-white px-2 py-3 group-hover:translate-y-0 transition-transform duration-300">
//           <Link
//             to={link}
...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="group relative select-none overflow-hidden">
      ...
      <Link
        to={link}
        className="block pointer-events-auto sm:pointer-events-none" 
      >
        <div className="relative aspect-[3/4] overflow-hidden">
          {/* Main Product Image */}
          <img
          ...
          <div className="absolute bottom-0 left-0 right-0 translate-y-full bg-white px-2 py-3 group-hover:translate-y-0 transition-transform duration-300 sm:block hidden">
            <Link
              to={link}
              className="block w-full py-2 border border-black text-center text-[12px] font-medium hover:bg-amber-400 transition-colors duration-300"
      ...
      <div className="p-4 text-center">
        ...
        <Link
          to={link}
          className="pointer-events-auto sm:pointer-events-none" // Clickable on mobile, disabled on desktop
        >
          <h3 className="text-gray-400 text-sm font-medium mb-1 group-hover:text-amber-400 transition-colors duration-300">
            {name}
          </h3>
